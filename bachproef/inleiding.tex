...
Aangezien de implementatie van speech-to-text nog niet geslaagd was, was er vraag naar een methode om stemmen te onderscheiden. Dit heeft als doel de implementatie van de transcriptie voor Vlaamse audio eenvoudiger te maken. Ook zal het gebruikt worden om er in de applicatie voor te zorgen dat enkel de stem van de student geanalyseerd wordt op signalen van elderspeak.
