...
Dit deel is op een zodanige manier opgebouwd dat als het model verder getraind zou worden, dit script eenvoudig met het nieuwe model gebruikt zou kunnen worden.
